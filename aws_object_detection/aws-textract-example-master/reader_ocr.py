...
if __name__ == '__main__':
    tts = TextToSpeech('com.apple.speech.synthesis.voice.daniel', 270, 1.0)
    # tts.list_available_voices()
    with open(r'E:\_AI_SEVERIN\aws_object_detection\aws-textract-example-master\most_common_word.txt', 'r') as f:
        text = f.read()
    
    
    tts.text_to_speech(text, save=True, file_name='output3.mp3')